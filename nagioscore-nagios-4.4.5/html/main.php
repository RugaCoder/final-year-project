...
<script type='text/javascript'>
	...
	<?php if ($cfg["enable_page_tour"]) { ?>
		var vbox;
		var vBoxId = "main";
		var vboxText = "<a href=https://coict.udsm.ac.tz/# target=_blank> " +
						"Click here to watch the entire Fyp Tour!</a>";
	<?php } ?>
	$(document).ready(function() {
		...
		<?php if ($cfg["enable_page_tour"]) { ?>
			vBoxId += ";" + user;
			vbox = new vidbox({pos:'lr',vidurl:'https://www.youtube.com/#',
		...
		// 	'<ul>', processNewsItem, '<li><a href="" target="_blank">More news...</a></li></ul>'
		// );
...
?>
		<div class="updatechecksdisabled">
			<div class="warningmessage">Warning: Automatic updates are disbaled because may affect our extended features, update if you only sure of what to do</div>
...
?>
		<div class="updateavailable">
			<div class="updatemessage">A new version of Nagios open source tool we use is availble wanna check it!</div>
...
<div id="splashboxes">
	...
	<div id='splashrow1'>
		...
		<div id="splashbox1" class="splashbox splashbox-clear">
			<h2>Get Started</h2>
			<ul>
				<li><a href="https://go.nagios.com/nagioscore/startmonitoring" target="_blank">Open source nagios tool used in this project</a></li>
				<!-- <li><a href="https://go.nagios.com/nagioscore/changelook" target="_blank">Change the look and feel of Nagios</a></li> -->
				<li><a href="#" target="_blank">Extend our project with hundreds of addons</a></li>
